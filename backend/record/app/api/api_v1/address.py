...
from app.services.address import create, update, get, get_all, delete, get_by_all_params
...
@router.get("/params/", response_model=Address)
def get_params(
    address1: str, city: str, state: str, zip: str, db: Session = Depends(get_db)
):
    return get_by_all_params(address1, city, state, zip, db)
